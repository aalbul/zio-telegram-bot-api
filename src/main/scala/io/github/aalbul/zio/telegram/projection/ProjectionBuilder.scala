...
class ProjectionBuilder(projector: UpdateProjector[UpdateProjection]) {
  ...
  def withForumTopicEditedMessage: ProjectionBuilder = plus(UpdateProjector[ForumTopicEditedMessage])
  def withForumTopicReopenedMessage: ProjectionBuilder = plus(UpdateProjector[ForumTopicReopenedMessage])
  def withGeneralForumTopicHiddenMessage: ProjectionBuilder = plus(UpdateProjector[GeneralForumTopicHiddenMessage])
  def withGeneralForumTopicUnhiddenMessage: ProjectionBuilder = plus(UpdateProjector[GeneralForumTopicUnhiddenMessage])
  def withWriteAccessAllowedMessage: ProjectionBuilder = plus(UpdateProjector[WriteAccessAllowedMessage])
  ...
  def withChatJoinRequest: ProjectionBuilder = plus(UpdateProjector[NewChatJoinRequest])
