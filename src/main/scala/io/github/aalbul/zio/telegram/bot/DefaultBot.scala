...
class DefaultBot extends Bot {
  ...
  override def editForumTopic(chatId: String, messageThreadId: Long): EditForumTopic =
    EditForumTopic.of(chatId, messageThreadId)
  ...
  override def deleteStickerFromSet(sticker: String): DeleteStickerFromSet = DeleteStickerFromSet.of(sticker)
  override def setStickerSetThumb(name: String, userId: Long): SetStickerSetThumb = SetStickerSetThumb.of(name, userId)
