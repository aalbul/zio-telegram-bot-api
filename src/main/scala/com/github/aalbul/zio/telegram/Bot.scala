...
import com.github.aalbul.zio.telegram.domain.command.{ForwardMessageRequest, GetUpdatesRequest, SendMessageRequest}
...
trait Bot {
  ...
  def copyMessage(request: ForwardMessageRequest): Task[MessageId]
}
